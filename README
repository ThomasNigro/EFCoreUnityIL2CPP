...
I know I should add all the dependencies (that's what we do with EF Core 1.1 and the old .NET scripting backend) but for the sake of simpicity of the sample I only added the main DLL.
